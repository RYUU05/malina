...
По требованиям сдачи нужно приложить ссылку на видео-демонстрацию в Google Drive или YouTube.

Рекомендуемый сценарий видео:

1. Показать первый вход нового пользователя.
2. Показать повторный вход и проверку пароля.
3. Показать добавление товара вручную.
4. Показать QR-сканер с главной страницы и из нижней навигации.
5. Показать корзину: категории, изменение количества, удаление, очистку.
6. Перезапустить приложение и показать, что данные корзины сохранились.
